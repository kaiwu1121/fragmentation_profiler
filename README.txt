...
Command:
LD_PRELOAD=./libfprof.so fprof_opt_dump_file=/path/to/result-file.txt fprof_opt_max_runs=1000 fprof_opt_max_size=2048 fprof_opt_dump_interval=2 fprof_opt_debug=1 <app> <args ...>
